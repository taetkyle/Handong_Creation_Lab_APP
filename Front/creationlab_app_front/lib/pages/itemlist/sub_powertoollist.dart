...
class subPowerToolList extends StatefulWidget {
  ...
  @override
  State<subPowerToolList> createState() => _subPowerToolListState();
}

class _subPowerToolListState extends State<subPowerToolList> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              fontGen(widget.modelname, "모델명", "Model Name"),
              fontGen(widget.warning, "주의 사항", "WARNING"),
              fontGen(widget.usage, "사용도", "Usage"),
              fontGen(widget.related, "관련 도구", "Related Tools"),
            ],
          ),
        ),
        bottomNavigationBar: (widget.resources.isNotEmpty)
            ? Container(
                height: 60,
